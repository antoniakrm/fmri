...
def resnet_encode(model_name, image_dir, encodings_path, image_classes_path, image_id_words_path=None):
  ...
  def encode_one_class(images_, image_class_id_):
    ...
    format_embeddings(features, image_ids, os.path.expanduser(f'/Dir/projects/summer_intern/data_words_images/images_embeddings_txt/{image_class_id_}.txt'))
...
def main():
  ...
  # encoded_image_classes, image_classes = resnet_encode(model, args.image_dir, encodings_path, image_classes_path, args.image_classes_id)
  # logger.info('Reducing dimensionality')
  # if args.n_components != 512:
